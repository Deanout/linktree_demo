...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference("Theme.count") do
      post themes_url, params: { theme: { css_value: @theme.css_value, name: @theme.name, premium: @theme.premium, theme_type: @theme.theme_type } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { css_value: @theme.css_value, name: @theme.name, premium: @theme.premium, theme_type: @theme.theme_type } }
